...
# -*- coding: utf-8 -*-
"""
Create the validation/test defect cohort manifest for Magnetic Tile Defect Dataset.

- Reads data/splits/magnetic_tile_split.json.
...
Default output:
    data/evaluation_manifests/magnetic_tile_defect_cohorts.json
"""
...
DATASET_NAME = "Magnetic Tile Defect Dataset"
DATASET_SLUG = "magnetic_tile"
DATA_ROOT_REL = Path("data/magnetic-tile-defect-datasets.-master")
SPLIT_JSON_REL = Path("data/splits/magnetic_tile_split.json")
OUTPUT_MANIFEST_REL = Path("data/evaluation_manifests/magnetic_tile_defect_cohorts.json")
