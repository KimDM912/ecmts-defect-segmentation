...
# -*- coding: utf-8 -*-
"""
Create the validation/test defect cohort manifest for Severstal Steel Defect Detection.

- Reads data/splits/severstal_split.json.
...
Default output:
    data/evaluation_manifests/severstal_defect_cohorts.json
"""
...
DATASET_SLUG = "severstal"
DATA_ROOT_REL = Path("data/severstal-steel-defect-detection")
SPLIT_JSON_REL = Path("data/splits/severstal_split.json")
OUTPUT_MANIFEST_REL = Path("data/evaluation_manifests/severstal_defect_cohorts.json")
